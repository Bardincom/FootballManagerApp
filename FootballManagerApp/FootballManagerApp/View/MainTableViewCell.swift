...
class MainTableViewCell: UITableViewCell {
    ...
    @IBOutlet private var playerLocation: UILabel!
    ...
    func setupPlayer(_ player: Player) {
        ...
        playerLocation.text = player.inPlay ? Location.inPlay.rawValue : Location.Bench.rawValue
        guard
        ...
        if player.inPlay {
            playerLocation.textColor = Color.oliveСolor
        } else {
            playerLocation.textColor = Color.gold
        }
    }
}
